<div class="header">
            ...
            <div class="header-top__user-panel header-top__user-panel_right">
                <ul class="header-top__user-menu header-top__user-menu_right user-menu">
                    ...
                    <li class="user-menu__item user-menu__item_right user-info">
                        ...
                        <div class="drop-profile" ng-controller="nurseAppController as nurseController">
    ...
    <div class="nav">
        <ul class="nav__list nav__list_left nav-list">
            ...
            <li class="nav-list__item">
                <a ui-sref="analyzes" ui-sref-active="nav-list__ref_active" class="nav-list__ref nav-list__icon nav-list__icon_notes">
                    <span class="nav-list__item-name">Анализы</span>
                </a>
