    ...
    <div class="nav">
        <ul class="nav__list nav__list_left nav-list">
            <li class="nav-list__item" >
                <a href="/doctor#/patients" class="nav-list__ref nav-list__ref_active nav-list__icon nav-list__icon_patients">
                    <span class="nav-list__item-name">Пациенты</span>
                </a>

            <li class="nav-list__item">
                <a href="/doctor#/emergency" class="nav-list__ref nav-list__icon nav-list__icon_register">
