                ...
                <ul class="header-top__user-menu header-top__user-menu_right user-menu">
                    ...
                    <li class="user-menu__item user-menu__item_right user-info">
                        ...
                        <div class="user-info__badge user-info__badge_right user-badge">
                            <span class="user-badge__name">Admin Administrator</span>
                            <span class="user-badge__post">Administrators</span>
                        </div>
    ...
    <div class="nav">
        <ul class="nav__list nav__list_left nav-list">
            <li class="nav-list__item" >
                <a href="/emergency#/patients" class="nav-list__ref nav-list__ref_active nav-list__icon nav-list__icon_patients">
                    <span class="nav-list__item-name">Поступившие</span>
                </a>

            <li class="nav-list__item">
                <a href="/emergency#/new_patient" class="nav-list__ref nav-list__icon nav-list__icon_register">
